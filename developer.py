...
class Developer:
    def __init__(self, root):
        ...
        title_lb1=Label(self.root,text="DEVELOPER",font=("times new romain",35,"bold"),bg="white",fg="red")
...
#Frame.
 ...
 #Developer info       
        dev_label=Label(main_frame,text="Hello my name ,kiran",font=("times new romain",20 ,"bold"),bg="white")
